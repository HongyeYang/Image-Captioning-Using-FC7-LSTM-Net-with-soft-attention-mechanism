...
def rnn_backward(dh, cache):
  ...
  for i in range(T-1,0,-1):
    dx[:,i,:],dh0,dWxx,dWhh,dbb=rnn_step_backward(dh[:,i,:]+dh0,cache[i])
    dWh+=dWhh
    dWx+=dWxx
    db+=dbb

  dx[:,0,:],dh0,dWxx,dWhh,dbb=rnn_step_backward(dh[:,0,:]+dh0,cache[0])
  dWh+=dWhh
  dWx+=dWxx
  db+=dbb
...
def lstm_step_forward(x, prev_h, prev_c, Wx, Wh, b):
  ...
  cache=(x,Wx,Wh,b,prev_h,i,f,o,g,prev_c,next_c)
...
def lstm_step_backward(dnext_h, dnext_c, cache):
  ...
  #############################################################################
  x,Wx,Wh,b,prev_h,i,f,o,g,prev_c,next_c=cache
  ...
  ddo=do*o*(1-o)
  ddg=dg*(1-g*g)
  da=np.concatenate((ddi,ddf,ddo,ddg),axis=1)
  db=np.sum(da,axis=0)
...
def lstm_backward(dh, cache):
  ...
  for i in reversed(range(T)):
    dx[:,i,:],ddh,dc,ddWx,ddWh,ddb=lstm_step_backward(dh[:,i,:]+ddh,dc,cache[i])
    dWh+=ddWh
    dWx+=ddWx
    db+=ddb
  dh0=ddh
